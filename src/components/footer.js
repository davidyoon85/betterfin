            ...
            <div className="footer">
                <div className="footer-left">
                    <a className="footer-brand" href="/">
                        <img className="footer-img" src="https://camp-away-dev.s3.amazonaws.com/betterfin_logo.svg" alt="" />
                    </a>
                </div>
                ...
                <div className="footer-bottom">
                    <div className="footer_social">
                        <a className="footer_social_icon" href="https://twitter.com/betterfin">
                            <img className="social_icon" src="https://assets.website-files.com/5c794ffa39d1ad7a031cec44/5c794ffb39d1ad099a1ced4e_twitter-icon-color.svg" alt="Twitter" />
                        </a>
                        <a className="footer_social_icon" href="https://www.instagram.com/betterfin/">
                            <img className="social_icon" src="https://assets.website-files.com/5c794ffa39d1ad7a031cec44/5c794ffb39d1ad813e1ced4c_instagram-icon-color.svg" alt="Instagram" />
                        </a>
                    </div>
